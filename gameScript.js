...
window.onload = function() {
    $("#ol").html(`<center>
                    <div id="inst"><h3>Welcome !</h3>Instructions For Game<br/><br/>
                    ...
                    <button onclick="start(3, 6)">3 x 6</button> 
                   </center>`);
}

// Other grids that We can use to play
//
